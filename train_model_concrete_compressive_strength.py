...
# ------------------------------------
path = "file:///C:/Users/piotr/OneDrive/Pulpit/Piotr/szkola/semestr3/big data/lab/concrete+compressive+strength/Concrete_Data.csv"  
...
model.write().overwrite().save("models/concrete_strength_model")
